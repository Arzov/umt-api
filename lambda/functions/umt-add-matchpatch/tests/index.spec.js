...
describe('Test AWS Lambda: umt-add-matchpatch', () => {
  ...
  test('Evaluar respuesta: Match - Parche (MAN. UNITED - REAL MADRID, svonko.vescovi@arzov.com)', (done) => {
  ...
  test('Evaluar respuesta: Match - Parche (FC BARCELONA - MAN. UNITED, svonko.vescovi@arzov.com)', (done) => {
