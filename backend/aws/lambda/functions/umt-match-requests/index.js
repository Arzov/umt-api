/**
 * Obtiene solicitudes de partidos del equipo
...
exports.handler = (event, context, callback) => {
    ...
    dql.matchOwnerRequests(dynamodb, process.env.DB_UMT_001, hashKey, limitScan,
        ...
        if (err) callback(err);
            ...
            dql.matchGuestRequests(dynamodb, process.env.DB_UMT_001, hashKey, limitScan,
